...
describe('AuthService', () => {
  ...
  describe('parseBasicToken', () => {
    ...
    it('should throw an error invalid token format', () => {
    ...
    it('should throw an error invalid Basic token format', () => {
  ...
  describe('parseBearerToken', () => {
    ...
    it('should throw a BadRequestException if payload type is not access but isRefreshToken parameter is false', () => {
      const rawToken = 'Bearer a';
