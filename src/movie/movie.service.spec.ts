...
describe('MovieService', () => {
  ...
  describe('findRecent', () => {
    ...
    it('should fetch recent movies from the repository and cache them if not found', async () => {
  ...
  describe('findAll', () => {
    ...
    beforeEach(() => {
      ...
      getLikedMovieMock = jest.spyOn(movieService, 'getLikedMovie');
    });
    ...
    it('should return a list of movies without user likes', async () => {
      ...
      expect(qb.where).toHaveBeenLastCalledWith('movie.title LIKE :title', {
        title: '%Movie%',
      });
      expect(
    ...
    it('should return a list of movies with user likes', async () => {
      ...
      const userId = 1;
      const reuslt = await movieService.findAll(dto, userId);
    ...
    it('should handle empty movieIds and return an empty result', async () => {
      const movies = [];
  ...
  describe('create', () => {
    ...
    it('should create a movie successfully', async () => {
      ...
      expect(createMovieDetailMock).toHaveBeenCalledWith(createMovieDto, qr);
      ...
      expect(createMovieGenreRelationMock).toHaveBeenLastCalledWith(
  ...
  describe('update', () => {
    ...
    it('should update a movie successfully', async () => {
      ...
      expect(updateMovieMock).toHaveBeenCalledWith(1, expect.any(Object), qr);
  ...
  describe('remove', () => {
    ...
    it('should remove a movie succesfully', async () => {
      ...
      expect(deleteMovieMock).toHaveBeenLastCalledWith(1);
  ...
  describe('toggleMovieLike', () => {
    ...
    it('should toggle movie like status successfully when like record exists and isLike different', async () => {
      const movie = { id: 1 };
      const user = { id: 1 };
